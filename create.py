...
\x1b[1;91m-----------------------------------------------
\x1b[1;97m> Author : Varun Dhawal
\x1b[1;97m> Github : https://github.com/varundhawal
...
def menu():
    ...
    if sel in['1', '01']:
        ...
        os.system('xdg-open https://www.facebook.com/varundhawal752588')
        menu()
    elif sel in ['3', '03']:
        os.system('xdg-open https://whatsapp.com/channel/0029Val61DiAO7RC2gjXw23E')
        menu()
    else:
